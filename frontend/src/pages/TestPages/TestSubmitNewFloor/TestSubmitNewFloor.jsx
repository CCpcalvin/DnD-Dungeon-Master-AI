...
const createMockApi = (sessionId) => {
  return {
    ...
    post: async (url) => {
        ...
        return {
          data: {
            ...
            events: [
              ...
              {
                role: "System",
                content: "Long long long long long text by system 2.",
              },
              {
                role: "Narrator",
      ...
      else if (url === `/session/${sessionId}/new-floor`) {
        const newMessage = {
          role: "Narrator",
          content: "Long long long long long text by narrator for new floor.",
        };
...
export default function TestSubmitNewFloor() {

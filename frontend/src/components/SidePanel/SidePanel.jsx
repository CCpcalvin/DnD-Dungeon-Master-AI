...
const SidePanel = ({ isOpen, onToggle, sessionId, api, children }) => {
    ...
    const fetchSessionInfo = async () => {
      ...
      try {
        const response = await api.get(
          `/session/${sessionId}/get-session-info`
        );
  ...
  const renderContent = () => {
        ...
        <div className="space-y-4 p-4">
          ...
          <div>
            ...
            <p className="text-gray-400">
              {sessionInfo.theme || "Not specified"}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400">
              {sessionInfo.current_floor || "Not specified"}
            </p>
          </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    ...
                    {playerInfo.dexterity !== undefined && (
                      <div className="text-gray-400">
                        ...
                        {playerInfo.dexterity}
                      </div>
                    )}
                    {playerInfo.constitution !== undefined && (
                      <div className="text-gray-400">
                        <span className="text-gray-300">CON</span>{" "}
                        {playerInfo.constitution}
                      </div>
                    )}
    ...
    return (
      <div className="text-gray-400 p-4">No session information available</div>
    );
  };
